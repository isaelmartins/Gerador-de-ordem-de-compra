  ...
  return (
    <div id="purchase-order-print" className="bg-white p-8 shadow-lg max-w-[210mm] mx-auto text-sm font-sans text-gray-800 border border-gray-200 print:shadow-none print:border-none print:p-0">
      ...
      <div className="mb-6">
        ...
        {/* Total Footer moved out of table */}
        <div className="w-full border-l border-r border-b border-gray-400 flex">
          <div className="flex-grow p-2 italic font-bold text-right pr-4 border-r border-gray-400">Preço Total (R$)</div>
          <div className="w-[112px] p-2 text-right font-bold text-[13px] bg-gray-50">
